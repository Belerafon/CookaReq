...
6. GUI: слева дерево документов, по центру лист выбранного документа, редактор элемента с Labels и Links, вкладка Trace (light), граф с раскраской по документам.
...
Таблица: RID, Title, Level, Active, Normative, Labels (бейджи), Links (счётчик), Attach.
...
Вкладки: Text, Labels, Links, References, Attachments.

Labels: мультиселект с цветом; если allowFreeform=false, блокировать неразрешённые.
...
Валидация: если allowFreeform=false в текущем документе, то каждый label ∈ effective_labels.keys().
...
PR4 — GUI: Редактор (Labels/Links), Document Settings

Вкладки Labels/Links, диалог линковки.
...
- 2025-09-18: CLI и мигратор перешли с `tags` на `labels`, добавлен аргумент `--labels`.
...
- 2025-09-22: Добавлен smoke-набор тестов.
- 2025-09-23: Восстановлен подробный план, миграция сохраняет ссылки.
