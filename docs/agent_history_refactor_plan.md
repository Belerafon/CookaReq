...
- [>] Шаг 5–6: обновить оставшиеся UI-тесты/снепшоты под событийную модель и убедиться, что экспорт истории и просмотрщики не тянут устаревшие поля из diagnostic и legacy-истории (ещё в работе, нужно покрыть сценарии миграции).
