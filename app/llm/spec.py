...
SYSTEM_PROMPT = (
    dedent(
        ...
        If the prompt is purely conversational, a translation, or tools are not applicable, reply in natural language without calling a tool, matching the language used in the user request.
