...
SYSTEM_PROMPT = (
    ...
    "format (case-sensitive). Each context entry is shown as `<RID> — <title>` (the title may be omitted); "
    ...
    "selected requirement(s), resolve them using the RID(s) from that section. Never pass only the numeric `id`. Examples:\n"
    ...
    "- Context entry \"SYS4 — Diagnostics\" and request \"Очисти все метки у SYS4\" → call "
