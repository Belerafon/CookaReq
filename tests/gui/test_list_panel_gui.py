...
REPORT_FLAG_THRESHOLDS = {
    ...
    "report_width_fallbacks": 42,
    "report_width_retry_async": 43,
    "report_width_retry": 44,
    "report_column_widths": 45,
    "report_list_item": 22,
    "report_clear_all": 23,
...
def test_try_apply_debug_profile_toggles_width_guard(wx_app, monkeypatch):
    ...
    disabled_profile = list_panel.ListPanelDebugProfile.from_level(45)
